...
(function(zrender){
    ...
    imageTree.prototype = {
        ...
        render: function(datas) {
            var render_image = function(This, data, parent, parent_position_start, parent_width, level_index, last_image_pos_y) {
                ...
                for (var i = 0; i < len; i++) {
                    ...
                    if (obj.hasOwnProperty('childrens')) {
                        render_image(This, obj.childrens, zr_obj, parent_position_start + pre_obj_width * i, pre_obj_width, level_index + 1, last_image_pos_y + obj.height);
                    }
                }
            };
